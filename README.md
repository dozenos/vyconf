...
Typical examples of software appliances in this sense are [DozenOS](http://dozenos.io),
...
for DozenOS, but it's not locked into it, and not limited to routers or firewalls.
...
VyConf development is discussed in the [DozenOS phabricator](https://phabricator.dozenos.net/project/profile/1/)
and the #dozenos IRC channel on Freenode.
