type cfg_op =
    | CfgSet of string list * string option * Dozenos1x.Config_tree.value_behaviour
    | CfgDelete of string list * string option

type world = {
    mutable running_config: Dozenos1x.Config_tree.t;
    mutable reference_tree: Dozenos1x.Reference_tree.t;
...
val get_changeset : world -> session_data -> Dozenos1x.Config_tree.t -> Dozenos1x.Config_tree.t -> cfg_op list
...
val get_proposed_config : world -> session_data -> Dozenos1x.Config_tree.t
...
val write_session_cache : world -> Dozenos1x.Config_tree.t -> (unit, string) result

val prepare_commit : ?dry_run:bool -> world -> session_data -> Dozenos1x.Config_tree.t -> string -> (Commitd_client.Commit.commit_data, string) result

val post_process_commit : world -> session_data -> Commitd_client.Commit.commit_data * Dozenos1x.Config_tree.t -> Dozenos1x.Config_tree.t * Dozenos1x.Config_tree.t
