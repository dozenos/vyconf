...
val load_config_cache : string -> (Dozenos1x.Config_tree.t, string) result

val load_config_failsafe : string -> string -> Dozenos1x.Config_tree.t

val load_interface_definitions : string -> (Dozenos1x.Reference_tree.t, string) result

val read_reference_tree : string -> (Dozenos1x.Reference_tree.t, string) result
